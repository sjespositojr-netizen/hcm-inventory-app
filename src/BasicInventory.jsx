...
const sampleItems = [
  ...
  { id: 'INV-012', itemName: 'Flowers – Butterfly Pea Flower', itemCode: 12, category: 'Beverage', isPriority: false, unitType: 'Piece', count: 0 },
  { id: 'INV-013', itemName: 'Flowers – Lavender Flowers', itemCode: 13, category: 'Beverage', isPriority: false, unitType: 'Piece', count: 0 },
  ...
  { id: 'INV-016', itemName: 'Onion – Red Jumbo', itemCode: 16, category: 'Food', isPriority: false, unitType: 'Piece', count: 0 },
  { id: 'INV-017', itemName: 'Bread – Potato Buns', itemCode: 17, category: 'Food', isPriority: true, unitType: 'Piece', count: 0 },
  { id: 'INV-018', itemName: 'Bread – Glizzy Buns', itemCode: 18, category: 'Food', isPriority: false, unitType: 'Piece', count: 0 },
  { id: 'INV-019', itemName: 'Bread – Slider Buns', itemCode: 19, category: 'Food', isPriority: false, unitType: 'Piece', count: 0 },
  { id: 'INV-020', itemName: 'Bread – White Club Loaf', itemCode: 20, category: 'Food', isPriority: true, unitType: 'Piece', count: 0 },
  { id: 'INV-021', itemName: 'Tortilla – Flour, 8"', itemCode: 21, category: 'Food', isPriority: true, unitType: 'Piece', count: 0 },
  { id: 'INV-022', itemName: 'Butter – Unsalted', itemCode: 22, category: 'Food', isPriority: false, unitType: 'Piece', count: 0 },
  { id: 'INV-023', itemName: 'Buttermilk', itemCode: 23, category: 'Food', isPriority: true, unitType: 'Piece', count: 0 },
  { id: 'INV-024', itemName: 'Cheese – Cheddar, Block', itemCode: 24, category: 'Food', isPriority: false, unitType: 'Piece', count: 0 },
  { id: 'INV-025', itemName: 'Cheese – Cheddar, Fancy Shredded', itemCode: 25, category: 'Food', isPriority: true, unitType: 'Piece', count: 0 },
  { id: 'INV-026', itemName: 'Cheese – Cheddar & Monterey Jack Blend', itemCode: 26, category: 'Food', isPriority: true, unitType: 'Piece', count: 0 },
  { id: 'INV-027', itemName: 'Heavy Cream – 36%', itemCode: 27, category: 'Food', isPriority: true, unitType: 'Piece', count: 0 },
  { id: 'INV-028', itemName: 'Ice Cream – Vanilla', itemCode: 28, category: 'Food', isPriority: false, unitType: 'Piece', count: 0 },
  { id: 'INV-029', itemName: 'Milk, Whole', itemCode: 29, category: 'Beverage', isPriority: false, unitType: 'Piece', count: 0 },
  { id: 'INV-030', itemName: 'Corn Nuggets', itemCode: 30, category: 'Food', isPriority: true, unitType: 'Case', count: 0 },
  { id: 'INV-031', itemName: 'Onion Rings', itemCode: 31, category: 'Food', isPriority: true, unitType: 'Case', count: 0 },
  { id: 'INV-032', itemName: 'Fries – Excalibur 3/8', itemCode: 32, category: 'Food', isPriority: true, unitType: 'Case', count: 0 },
  { id: 'INV-033', itemName: 'Waffles – Belgian', itemCode: 33, category: 'Food', isPriority: true, unitType: 'Case', count: 0 },
  { id: 'INV-034', itemName: 'Canola Salad Oil', itemCode: 34, category: 'Food', isPriority: true, unitType: 'Case', count: 0 },
  ...
  { id: 'INV-041', itemName: 'Honey Blend', itemCode: 41, category: 'Food', isPriority: true, unitType: 'Piece', count: 0 },
  ...
  { id: 'INV-045', itemName: 'Pan Spray, All Purpose', itemCode: 45, category: 'Food', isPriority: false, unitType: 'Piece', count: 0 },
  { id: 'INV-046', itemName: 'Pasta – Elbows', itemCode: 46, category: 'Food', isPriority: true, unitType: 'Piece', count: 0 },
  { id: 'INV-047', itemName: 'Pickles – Kosher Dill', itemCode: 47, category: 'Food', isPriority: true, unitType: 'Piece', count: 0 },
  { id: 'INV-048', itemName: 'Pimentos, #10 Can', itemCode: 48, category: 'Food', isPriority: false, unitType: 'Piece', count: 0 },
  { id: 'INV-049', itemName: 'Sauce – Plain Salt', itemCode: 49, category: 'Food', isPriority: false, unitType: 'Piece', count: 0 },
  { id: 'INV-050', itemName: 'Sauce – BBQ Sauce Cups', itemCode: 50, category: 'Food', isPriority: false, unitType: 'Piece', count: 0 },
  { id: 'INV-051', itemName: 'Sauce – Honey BBQ', itemCode: 51, category: 'Food', isPriority: false, unitType: 'Piece', count: 0 },
  { id: 'INV-052', itemName: 'Sauce – Ketchup Bottles', itemCode: 52, category: 'Food', isPriority: false, unitType: 'Piece', count: 0 },
  ...
  { id: 'INV-060', itemName: 'Spices – Garlic Granulated', itemCode: 60, category: 'Food', isPriority: true, unitType: 'Piece', count: 0 },
  { id: 'INV-061', itemName: 'Spices – Lemon Pepper', itemCode: 61, category: 'Food', isPriority: false, unitType: 'Piece', count: 0 },
  { id: 'INV-062', itemName: 'Spices – Onion Granulated', itemCode: 62, category: 'Food', isPriority: true, unitType: 'Piece', count: 0 },
  { id: 'INV-063', itemName: 'Spices – Paprika', itemCode: 63, category: 'Food', isPriority: true, unitType: 'Piece', count: 0 },
  { id: 'INV-064', itemName: 'Sugar – Dark Brown', itemCode: 64, category: 'Beverage', isPriority: false, unitType: 'Piece', count: 0 },
  { id: 'INV-065', itemName: 'Sugar – Granulated White', itemCode: 65, category: 'Beverage', isPriority: false, unitType: 'Piece', count: 0 },
  { id: 'INV-066', itemName: 'Sugar – Light Brown', itemCode: 66, category: 'Food', isPriority: true, unitType: 'Piece', count: 0 },
  ...
  { id: 'INV-071', itemName: 'Vinegar – Malt', itemCode: 71, category: 'Food', isPriority: false, unitType: 'Piece', count: 0 },
  { id: 'INV-072', itemName: 'Vinegar – White Distilled', itemCode: 72, category: 'Food', isPriority: false, unitType: 'Piece', count: 0 },
  { id: 'INV-073', itemName: 'Waffle & Pancake Mix', itemCode: 73, category: 'Food', isPriority: false, unitType: 'Piece', count: 0 },
  { id: 'INV-074', itemName: 'Spices – Habanero', itemCode: 74, category: 'Food', isPriority: false, unitType: 'Piece', count: 0 },
  { id: 'INV-075', itemName: 'Spices – Ghost Pepper', itemCode: 75, category: 'Food', isPriority: false, unitType: 'Piece', count: 0 },
  ...
  { id: 'INV-078', itemName: 'Aluminum Foil – Standard Roll', itemCode: 78, category: 'Non-Food', isPriority: false, unitType: 'Case', count: 0 },
  { id: 'INV-079', itemName: 'Aluminum Tray – Half Size Tray', itemCode: 79, category: 'Non-Food', isPriority: false, unitType: 'Case', count: 0 },
  { id: 'INV-080', itemName: 'Aluminum Tray – Half Size Lid', itemCode: 80, category: 'Non-Food', isPriority: false, unitType: 'Case', count: 0 },
  ...
  { id: 'INV-084', itemName: 'Bags – Paper 20#', itemCode: 84, category: 'Non-Food', isPriority: false, unitType: 'Case', count: 0 },
  { id: 'INV-085', itemName: 'Bags – Plastic, 1/6', itemCode: 85, category: 'Non-Food', isPriority: false, unitType: 'Case', count: 0 },
  { id: 'INV-086', itemName: 'Box – Catering Box, Half', itemCode: 86, category: 'Non-Food', isPriority: false, unitType: 'Case', count: 0 },
  { id: 'INV-087', itemName: 'Box – Catering Tray, Full', itemCode: 87, category: 'Non-Food', isPriority: false, unitType: 'Case', count: 0 },
  ...
  { id: 'INV-100', itemName: 'Deli Container – 16 oz', itemCode: 100, category: 'Non-Food', isPriority: false, unitType: 'Case', count: 0 },
  { id: 'INV-101', itemName: 'Deli Container – 32 oz', itemCode: 101, category: 'Non-Food', isPriority: false, unitType: 'Case', count: 0 },
  { id: 'INV-102', itemName: 'Deli Container – Lids', itemCode: 102, category: 'Non-Food', isPriority: true, unitType: 'Case', count: 0 },
  { id: 'INV-103', itemName: 'Deli Wrap – 12x12 Black Checkered', itemCode: 103, category: 'Non-Food', isPriority: false, unitType: 'Case', count: 0 },
  { id: 'INV-104', itemName: 'Deli Wrap – 12x12 Red Checkered', itemCode: 104, category: 'Non-Food', isPriority: false, unitType: 'Case', count: 0 },
  ...
  { id: 'INV-106', itemName: 'Foil Wrap – Cushioned, 10.5x14', itemCode: 106, category: 'Non-Food', isPriority: false, unitType: 'Case', count: 0 },
  { id: 'INV-107', itemName: 'Napkins – Kraft', itemCode: 107, category: 'Non-Food', isPriority: false, unitType: 'Case', count: 0 },
  { id: 'INV-108', itemName: 'Paper Towel Roll – Kraft Hardwound', itemCode: 108, category: 'Non-Food', isPriority: false, unitType: 'Case', count: 0 },
  { id: 'INV-109', itemName: 'Paper Towel – Z Fold', itemCode: 109, category: 'Non-Food', isPriority: false, unitType: 'Case', count: 0 },
  { id: 'INV-110', itemName: 'Plastic Wrap – 12"x2000\'', itemCode: 110, category: 'Non-Food', isPriority: false, unitType: 'Case', count: 0 },
  { id: 'INV-111', itemName: 'Ramekin lids – 1.5 oz (1.5 oz/2 oz)', itemCode: 111, category: 'Non-Food', isPriority: true, unitType: 'Case', count: 0 },
  { id: 'INV-112', itemName: 'Ramekin lids – 4 oz (3.25 oz/4 oz)', itemCode: 112, category: 'Non-Food', isPriority: false, unitType: 'Case', count: 0 },
  ...
  { id: 'INV-115', itemName: 'Receipt Paper – Small CC Thermal', itemCode: 115, category: 'Non-Food', isPriority: false, unitType: 'Case', count: 0 },
  { id: 'INV-116', itemName: 'Receipt Paper – 3 1/8" Thermal', itemCode: 116, category: 'Non-Food', isPriority: false, unitType: 'Case', count: 0 },
  { id: 'INV-117', itemName: 'Straws – 7.75" Wrapped', itemCode: 117, category: 'Non-Food', isPriority: false, unitType: 'Case', count: 0 },
  { id: 'INV-118', itemName: 'Straws – 10" Jumbo Shake', itemCode: 118, category: 'Non-Food', isPriority: false, unitType: 'Case', count: 0 },
  { id: 'INV-119', itemName: 'Tray – Hot Dog Checkerboard', itemCode: 119, category: 'Non-Food', isPriority: false, unitType: 'Case', count: 0 },
  { id: 'INV-120', itemName: 'Tray – 1lb, checkerboard', itemCode: 120, category: 'Non-Food', isPriority: false, unitType: 'Case', count: 0 },
  ...
  { id: 'INV-123', itemName: 'Tray – 5lb, checkerboard', itemCode: 123, category: 'Non-Food', isPriority: true, unitType: 'Case', count: 0 },
  { id: 'INV-124', itemName: 'Bleach', itemCode: 124, category: 'Cleaning Supplies', isPriority: false, unitType: 'Case', count: 0 },
  { id: 'INV-125', itemName: 'Can Liner – 55 gallon', itemCode: 125, category: 'Cleaning Supplies', isPriority: false, unitType: 'Case', count: 0 },
  ...
  { id: 'INV-129', itemName: 'Dish Soap – Emerald', itemCode: 129, category: 'Cleaning Supplies', isPriority: false, unitType: 'Piece', count: 0 },
  { id: 'INV-130', itemName: 'Floor Cleaner – Degreasing Cleaner', itemCode: 130, category: 'Cleaning Supplies', isPriority: false, unitType: 'Piece', count: 0 },
  { id: 'INV-131', itemName: 'Gloves – Poly, Large', itemCode: 131, category: 'Cleaning Supplies', isPriority: false, unitType: 'Case', count: 0 },
  { id: 'INV-132', itemName: 'Gloves – Vinyl, Large', itemCode: 132, category: 'Cleaning Supplies', isPriority: false, unitType: 'Case', count: 0 },
  { id: 'INV-133', itemName: 'Gloves – Vinyl, XL', itemCode: 133, category: 'Cleaning Supplies', isPriority: false, unitType: 'Case', count: 0 },
  { id: 'INV-134', itemName: 'Hand Soap – Softsoap', itemCode: 134, category: 'Cleaning Supplies', isPriority: false, unitType: 'Piece', count: 0 },
  { id: 'INV-135', itemName: 'Mop – #32', itemCode: 135, category: 'Cleaning Supplies', isPriority: false, unitType: 'Piece', count: 0 },
  ...
  { id: 'INV-140', itemName: 'Toilet Paper', itemCode: 140, category: 'Cleaning Supplies', isPriority: false, unitType: 'Piece', count: 0 },
      ...
      <div className="w-full max-w-3xl mx-auto space-y-4">
        ...
        <header className="rounded-2xl bg-zinc-900 p-4 text-stone-100 shadow-md border-b-4 border-red-700">
          <div className="flex items-center gap-4">
            <img src="/icon-192.png" alt="Logo" className="h-12 w-12 shrink-0 rounded-xl object-cover" />
            <div>
